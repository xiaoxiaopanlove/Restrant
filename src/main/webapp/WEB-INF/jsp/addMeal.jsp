...
<tr>
	...
	<td valign="top" width="80%">
		...
		<br />
		<form action="${pageContext.request.contextPath}/doAddMeal" method="post" enctype="multipart/form-data">
			<table align="center" >
				<tr>
					<td>菜名:</td><td>
					<input name="mealName" type="text" value=""/></td>
				</tr><tr>
				<td>菜系:</td><td><select name="mealSeriesId">
				<c:forEach var="mealSeries" items="${requestScope.mealSeries}">
					<option value="${mealSeries.seriesId}">${mealSeries.seriesName } </option>
				</c:forEach>
			</select></td>
			</tr><tr>
				<td>摘要:</td><td><textarea name="mealSummarize"></textarea></td>
			</tr><tr>
				<td>介绍:</td><td><textarea name="mealDescription"></textarea></td>
			</tr><tr>
				<td>价格:</td><td><input name="mealPrice" type="text" value=""/></td>
			</tr><tr>
				<td>图片:</td><td>
