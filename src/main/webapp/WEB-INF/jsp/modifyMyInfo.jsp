...
<tr>
	...
	<td valign="top" width="80%">
		...
		<form action="${pageContext.request.contextPath}/modifyUser" method="post" name="ufrm"
			...
			<table width="100%" cellspacing="0" cellpadding="3" align="center"
				...
				<tr>
					...
					<td align="left">
						<input type="text" name="loginName" style="width:220px;" value="${sessionScope.user.loginName }"/>
					</td>
				...
				<tr>
					...
					<td align="left">
						<input type="password" name="loginPwd" style="width:220px;" value="${sessionScope.user.loginPwd }"/>
					</td>
				...
				<tr>
					...
					<td align="left">
						<input type="text" name="trueName" style="width:220px;" value="${sessionScope.user.trueName }"/>
					</td>
				...
				<tr>
					...
					<td align="left">
						<input type="text" name="phone" style="width:220px;" value="${sessionScope.user.phone }"/>
					</td>
				...
				<tr>
					...
					<td align="left">
						<input type="text" name="email" style="width:220px;" value="${sessionScope.user.email }"/>
					</td>
				...
				<tr>
					...
					<td align="left">
						<input type="text" name="address" style="width:220px;" value="${sessionScope.user.address }"/>
					</td>
				...
				<tr style="background-color:#CCCCFF;">
					<td colspan="3">
						...
						<input name="register" type="submit" id="register" value="确定" />
					</td>
				</tr>
			</table>
		</form>
